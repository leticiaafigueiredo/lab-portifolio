...
export const Hero: React.FC<HeroProps> = ({ currentUser, onToggleUser, theme }) => {
    ...
    <section ref={heroRef} className="py-[56px] pb-[90px] grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
      <div>
        ...
        <motion.h1 
          ...
          className="font-['Caveat'] text-[5rem] font-bold text-[#221F1B] leading-[1.05] m-0 mb-[6px]"
        >
          Oi, eu sou<br />
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="relative aspect-[1/1.05] w-full rotate-[-1.5deg] border-[2.5px] border-[#221F1B] rounded-[4px_16px_4px_18px/16px_4px_20px_4px] [filter:url(#roughen)] bg-[#EFE6D2] p-[14px]">
        ...
        <button
          ...
          className="font-['Space_Mono'] text-[0.8rem] font-bold bg-[#F4C23D] text-[#221F1B] px-[18px] py-[10px] cursor-pointer relative inline-block border-2 border-[#221F1B] rounded-[3px_14px_4px_12px/12px_4px_14px_3px] [filter:url(#roughen)] hover:opacity-90 transition-opacity shadow-sm mt-2"
        >
